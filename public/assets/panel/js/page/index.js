...
var myChart = new Chart(balance_chart, {
    type: "line",
    data: {
        labels: datasChartBelence.map((data) => data.days),
        datasets: [
            {
                label: "Balance",
                data: datasChartBelence.map((data) => data.balance),
...
var myChart = new Chart(sales_chart, {
    type: "line",
    data: {
        labels: datasChartWhitedraw.map((data) => data.days),
        datasets: [
            {
                label: "Sales",
                data: datasChartWhitedraw.map((data) => data.balance),
                borderWidth: 2,
                backgroundColor: balance_chart_bg_color,
                borderWidth: 3,
                borderColor: "rgba(35,159,225,1)",
