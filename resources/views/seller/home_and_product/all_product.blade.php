                            ...
                            <div class="swiper-wrapper rounded-3" style="width: auto;">
                                @foreach ($seller_banners as $banner)
                                    <div class="swiper-slide rounded-3">
                                        <img class="w-100 rounded-3 object-fit-cover"
                                            src="{{ asset('uploads/banner/' . $banner->image) }}" alt="{{ $banner->title }}"
                                            style="max-height: 32rem; height:100%;">
                                    </div>
                                @endforeach
                            </div>
                        ...
                        {{-- <div class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><button class="dropdown-item" type="button"
                                        style="cursor: pointer; font-size: 14px; line-height: 1.5;">Terbaru</button></li>
                                <li><button class="dropdown-item" type="button"
                                        style="cursor: pointer; font-size: 14px; line-height: 1.5;">Harga Terendah</button>
                                </li>
                                <li><button class="dropdown-item" type="button"
                                        style="cursor: pointer; font-size: 14px; line-height: 1.5;">Harga
                                        Tertinggi</button></li>
                                <li><button class="dropdown-item" type="button"
                                        style="cursor: pointer; font-size: 14px; line-height: 1.5;">Nama A-Z</button></li>
                            </ul>
                        </div> --}}
                        <div class="dropdown">
                            <button class="btn btn-outline-primary dropdown-toggle" type="button" data-bs-toggle="dropdown"
